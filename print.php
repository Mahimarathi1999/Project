...
@media(max-width:575px) {
	...
	.invoice .from,.invoice .payment-details {
		float:none;
		width:100%;
		text-align:center;
		margin-bottom:25px;
		  ...
		  <div class="panel-body">
		    ...
		    <div class="row">
				...
				<div class="col-sm-6 top-right">
						<h2 class="marginright">INVOICE-1234578</h2>
						<span class="marginright">4 April 2021</span>
			    </div>
			...
			<div class="row">
				...
				<div class="col-xs-4 from">
					<p class="lead marginbottom">From : Amit</p>
				...
				<table class="table table-striped">
			      ...
			      <tbody>
			        <!--<tr>
			          ...
			          <td class="text-right">Rs18</td>
			          <td class="text-right">Rs180</td>
			        </tr>-->
			        <tr>
			          <td class="text-center">2</td>
			          <td>Flat Icons</td>
			          <td class="text-right">6</td>
			          <td class="text-right">Rs59</td>
			          <td class="text-right">Rs254</td>
			        </tr>
			        <tr>
			          <td class="text-center">3</td>
			          <td>Wordpress version</td>
			          <td class="text-right">4</td>
			          <td class="text-right">Rs95</td>
			          <td class="text-right">Rs285</td>
			        </tr>
			         <tr class="last-row">
			          <td class="text-center">4</td>
			          <td>Server Deployment</td>
			          <td class="text-right">1</td>
			          <td class="text-right">Rs300</td>
			          <td class="text-right">Rs300</td>
			        </tr>
			       </tbody>
			    </table>
